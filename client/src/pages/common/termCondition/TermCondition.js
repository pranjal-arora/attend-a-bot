    ...
    <Layout className="home layout">
      ...
      <Content>
        <Card>
          ...
          <p>Welcome to Attend-a-bot!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Attend-a-bot's Website, located at
            https://Attend-a-bot.netlify.app.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Attend-a-bot if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Attend-a-bot, you agreed
            to use cookies in agreement with the Attend-a-bot's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Attend-a-bot and/or its licensors own the
            intellectual property rights for all material on Attend-a-bot. All
            intellectual property rights are reserved. You may access this from
            Attend-a-bot for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Attend-a-bot</li>
            <li>Sell, rent or sub-license material from Attend-a-bot</li>
            <li>Reproduce, duplicate or copy material from Attend-a-bot</li>
            <li>Redistribute content from Attend-a-bot</li>
          </ul>
          ...
          <p>
            ...
            Attend-a-bot does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Attend-a-bot,its agents and/or affiliates.
            ...
            Attend-a-bot shall not be liable for the Comments or for any
          ...
          <p>
            Attend-a-bot reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Attend-a-bot a non-exclusive license to use,
          ...
          <p>
            ...
            Attend-a-bot; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Attend-a-bot. Please include your name, your
          ...
          <p>
            No use of Attend-a-bot's logo or other artwork will be allowed for
